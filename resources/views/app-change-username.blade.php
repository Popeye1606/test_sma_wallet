                    ...
                    <div class="card-body pb-1">
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                <label class="label" for="username">ชื่อผู้ใช้เดิม</label>
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                <label class="label" for="username">ชื่อผู้ใช้ใหม่</label>
                                <input type="text" class="form-control" id="username" name="username" placeholder="Type new username">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
